...
export default function Layout({children}) {
  ...
  return (
    <div className="flex w-full min-h-screen">
      {/* Sidebar Start */}
      <motion.div initial={animate.initial} animate={animate.animate} transition={animate.transition} className={`fixed h-screen w-80 bg-indigo-700 z-50 ${displayNav ? "block" : "block"} lg:block`}>
        ...
        <div className="w-full mt-12 text-white">
          <div className="w-full flex flex-col pl-11">
            ...
            <NavLink to={nav.url} activeClassName="bg-purple-50 text-indigo-700" className="my-1 py-4 pl-6 w-full flex hover:bg-purple-50 hover:text-indigo-700 rounded-tl-full rounded-bl-full cursor-pointer" key={i}>
      ...
      <div className={`fixed h-screen w-80 bg-indigo-700 z-50 ${displayNav ? "hidden" : "hidden"} lg:block`}>
        <div className=" w-full mt-12 flex justify-center">
          <img
            src="https://res.cloudinary.com/jewbreel1/image/upload/v1627500985/sms/Logo/staff_logo_labbas.png"
            alt=""
